...
apps = pd.read_csv("/content/Google_Playstore/csv_files/Play Store Data.csv")
reviews = pd.read_csv("/content/Google_Playstore/csv_files/User Reviews.csv")
